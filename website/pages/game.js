    ...
    function createResults(data, odds, eval, wanted_book){
        ...
        for (d of data){
            ...
            column.append("img").style("margin-bottom", "25px")
                    ...
                    .attr("align", "center").attr("src", `Resources/assets/images/NBA/${img_name}.png`)
        ...
        .attr("align", "center").attr("src", `Resources/assets/images/NBA/${added_obj.spread_team}.png`)
        ...
        .attr("align", "center").attr("src", `Resources/assets/images/NBA/${added_obj.ml_team}.png`)
